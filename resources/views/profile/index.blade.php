...
<section id="about" class="about">
  ...
  <div class="text-center"> <a href="{{route('profile.edit', $profile->id)}}" class="btn btn-md btn-success">Edit Profile Sekolah</a></div>
  @endforeach
  @else
  <div class="text-center"> <a href="{{route('profile.create')}}" class="btn btn-md btn-success">Buat Data Profile Sekolah</a></div>
  @endif
</section><!-- End About -->
@endsection